				...
				struct mkimage_params *params)
{
	...
	/* delete the time stamp of hdr to support ota update of boot partition.
	 * boot.img will be different if it was made at different time,
	 * even thought the source files were same.
