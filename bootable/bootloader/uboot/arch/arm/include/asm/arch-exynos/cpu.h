...
#define RST_STAT_REG_OFFSET		0x404
#define RST_STAT_REG			__REG(S5PV310_POWER_BASE+RST_STAT_REG_OFFSET)
...
/* PMU Register */
#define S5P_PA_PMU_BASE		(0x10020000)
#define S5P_PMUREG(x)		(S5P_PA_PMU_BASE + (x))
...
#define S5P_PMU_GPSALIVE_CONF			S5P_PMUREG(0x3D00)


/* CMU register*/
#define S5P_PA_CMU_BASE		(0x10030000)
#define EXYNOS_CLKREG(x)	(S5P_PA_CMU_BASE + (x))
...
#define EXYNOS4_CLKGATE_IP_GPS		EXYNOS_CLKREG(0x0C940)
