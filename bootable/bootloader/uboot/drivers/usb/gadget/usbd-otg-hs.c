 ...
 * 2: power connected
 * 3: bad usb connected*/
int s3c_usb_connected_status= 0;
...
/* if not for check status, do not need wait cable insert */
int s3c_usbctl_init(int ischeckstatus)
{
	u8 ucMode;
...
int s3c_check_usb_connect_status(void)
{
