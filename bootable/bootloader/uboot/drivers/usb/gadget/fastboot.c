...
#define _1M			(unsigned long long)(1 * 1024 * 1024)
#define RAW_AREA_SIZE	(20 * _1M)
#define SYSTEM_START	RAW_AREA_SIZE
#define SYSTEM_LENGTH	(400 * _1M)
#define USERDATA_START	SYSTEM_START+SYSTEM_LENGTH
#define USERDATA_LENGTH	(2500 * _1M)
#define CACHE_START		USERDATA_START+USERDATA_LENGTH
#define CACHE_LENGTH	(100 * _1M)
#define CPIMAGE_START	CACHE_START+CACHE_LENGTH
#define CPIMAGE_LENGTH	(32 * _1M)
#define PRELOAD_START	CPIMAGE_START+CPIMAGE_LENGTH
#define PRELOAD_LENGTH	(200 * _1M)

#define BOOT_START	PRELOAD_START+PRELOAD_LENGTH
#define BOOT_LENGTH	(20 * _1M)

#define RECOVERY_START	BOOT_START+BOOT_LENGTH
#define RECOVERY_LENGTH	(20 * _1M)

#define FAT_START		RECOVERY_START+RECOVERY_LENGTH
...
{
	{
		.name     = "fat",
		.start    = FAT_START,
		.length   = 0, /* the length will be got later */
		.flags    = FASTBOOT_PTENTRY_FLAGS_USE_MMC_CMD
	},
	{
		.name     = "system",
		.start    = SYSTEM_START,
