...
#define CONFIG_BOOTCOMMAND	"bootm 40008000 41000000"
#define CONFIG_BOOTARGS 	"console=ttySAC3,115200n8 androidboot.console=ttySAC3 no_console_suspend testmode=0 sec_log=512K@0x5FF80000 vmalloc=300M"
...
#define CONFIG_SYS_PROMPT		"STUTTGART # "
...
#define CONFIG_IDENT_STRING		" for STUTTGART"
...
*/
/* Fastboot variables */
#define CFG_FASTBOOT_TRANSFER_BUFFER            (0x58000000)
#define CFG_FASTBOOT_TRANSFER_BUFFER_SIZE       (0x28000000)   /* 640MB */
...
#define MACH_TYPE_STUTTGART		3972
...
/* --wipe_data:  erase data
 * --wipe_cache: erase cache
 * --show_text:  show text menu
 */
#define RECOVERY_ERASE_DATA		"--wipe_data\n"
#define RECOVERY_ERASE_CACHE	"--wipe_cache\n"
#define RECOVERY_SHOW_TEXT		"--show_text\n"
