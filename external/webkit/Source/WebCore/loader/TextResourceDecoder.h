...
private:
    ...
    //FIXED: if there are other characters before XML declaration, couldn't open webpag that have the following error message
    ...
    size_t checkXMLBeforeDeclaration(const char*, size_t, size_t);
