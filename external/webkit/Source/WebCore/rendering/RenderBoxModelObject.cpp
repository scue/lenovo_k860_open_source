                                       ...
                                       const RenderStyle* style, bool includeLogicalLeftEdge, bool includeLogicalRightEdge)
{
    ...
    if (renderTop) {
        ...
        /***RK_ID:RK_WEBKIT. DEP_RK_ID:NULL. AUT:wangwf1@lenovo.com. DATE:2012-05-05. START***/
        /*** for bug 167038 telecom test 121.8.100.132:8080/fb/s8/s8.htm ***/
        if(isHR() && style->getColorForHRElement().isValid() && (style->getColorForHRElement() != Color::black)) {
        drawLineForBoxSide(graphicsContext, x, ty, x2, ty + style->borderTopWidth(), BSTop, style->getColorForHRElement(), topStyle,
	...
	/***RK_ID:RK_WEBKIT. DEP_RK_ID:NULL. AUT:wangwf1@lenovo.com. DATE:2012-05-05. END***/
    ...
    if (renderBottom) {
        ...
        /*** for bug 167038 telecom test 121.8.100.132:8080/fb/s8/s8.htm ***/
        if(isHR() && style->getColorForHRElement().isValid() && (style->getColorForHRElement() != Color::black)) {
        drawLineForBoxSide(graphicsContext, x, ty + h - style->borderBottomWidth(), x2, ty + h, BSBottom, style->getColorForHRElement(), bottomStyle,
                   ignoreLeft ? 0 : style->borderLeftWidth(), ignoreRight ? 0 : style->borderRightWidth());
        }
        else {
    ...
    if (renderLeft) {
        ...
        /*** for bug 167038 telecom test 121.8.100.132:8080/fb/s8/s8.htm ***/
        if(isHR() && style->getColorForHRElement().isValid() && (style->getColorForHRElement() != Color::black)) {
        drawLineForBoxSide(graphicsContext, tx, y, tx + style->borderLeftWidth(), y2, BSLeft, style->getColorForHRElement(), leftStyle,
    ...
    if (renderRight) {
        ...
        /*** for bug 167038 telecom test 121.8.100.132:8080/fb/s8/s8.htm ***/
        if(isHR() && style->getColorForHRElement().isValid() && (style->getColorForHRElement() != Color::black)) {
        drawLineForBoxSide(graphicsContext, tx + w - style->borderRightWidth(), y, tx + w, y2, BSRight, style->getColorForHRElement(), rightStyle,
                   ignoreTop ? 0 : style->borderTopWidth(), ignoreBottom ? 0 : style->borderBottomWidth());
        }
        else {
